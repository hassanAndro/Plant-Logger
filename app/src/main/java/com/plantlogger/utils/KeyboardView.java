...
/**
 * Created by Hassan_Hameed on 3/8/2018.
 */
...
public class KeyboardView extends FrameLayout implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        $(R.id.t9_key_minus).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.t9_key_minus: { // handle clear button
                mPasswordField.setText("-");
            }
            break;
            case R.id.t9_key_dot: { // handle clear button
                mPasswordField.setText(".");
            }
            break;
    ...
    public void setInputType(int type) {
         mPasswordField.setInputType(type);
    }
